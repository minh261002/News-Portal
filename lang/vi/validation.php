...
return [
    ...
    | lớp trình xác thực. Một số quy tắc này có nhiều phiên bản như các quy tắc
    | về kích thước. Bạn có thể tự do chỉnh sửa các thông báo này ở đây.
    |
    */
    ...
    'ascii' => ':attribute chỉ có thể chứa các ký tự chữ và số đơn byte và các ký hiệu.',
    ...
    | quy ước "attribute.rule" để đặt tên các dòng. Điều này giúp nhanh chóng
    | chỉ định một dòng thông báo tùy chỉnh cho quy tắc thuộc tính nhất định.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Các dòng ngôn ngữ sau được sử dụng để thay thế chỗ trống thuộc tính của chúng tôi
    | với một cái gì đó thân thiện hơn với người đọc như "Địa chỉ E-Mail" thay vì "email".
    | Điều này giúp chúng tôi làm cho thông báo của mình rõ ràng hơn.
    |
    */
