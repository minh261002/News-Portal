            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumbs bg-light mb-4">
                        ...
                        <li class="breadcrumbs__item">
                            <a href="javascript:;" class="breadcrumbs__url">{{ __('Bài viết') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                                    ...
                                    <div class="article__entry">
                                        ...
                                        <div class="article__content">
                                            ...
                                            <ul class="list-inline">
                                                ...
                                                <li class="list-inline-item">
                                                    <span
                                                        class="text-dark text-capitalize">{{ date('M d, Y', strtotime($post->created_at)) }}</span>
                                                </li>
                                            </ul>
                                            <h5>
                                                <a href="{{ route('news.detail', $post->slug) }}">
                ...
                <div class="sidebar-sticky">
                                            ...
                                            <div class="card__post__body">
                                                <div class="card__post__content">
                                                    <div class="card__post__author-info mb-2">
                                                        <ul class="list-inline">
                                                            <li class="list-inline-item">
                                                                <span class="text-primary">{{ $news->author->name }}</span>
                                                            </li>
                                                            <li class="list-inline-item">
                                                                <span
                                                                    class="text-dark text-capitalize">{{ date('M d, Y', strtotime($news->created_at)) }}</span>
                                                            </li>
                                                        </ul>
                                                    </div>
                    ...
                    <aside class="wrapper__list__article">
                        ...
                        <form class="widget__form-subscribe bg__card-shadow" id="form-newsletter">
                            @csrf
                            <h6>{{ _('Nhận bản tin hàng ngày từ chúng tôi') }}</h6>
                            <p><small>{{ _('Vui lòng nhập email của bạn') }}</small></p>
                            <div class="input-group">
                                <input type="email" class="form-control" placeholder="{{ _('Địa chỉ email') }}"
                                    name="email" id="newsletter-email">
                                <div class="input-group-append">
                                    <button class="btn btn-primary" type="submit">{{ _('Đăng ký') }}</button>
                                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="sidebar-sticky">
                                                    ...
                                                    <div class="card__post__content">
                                                        <div class="card__post__author-info mb-2">
                                                            <ul class="list-inline">
                                                                <li class="list-inline-item">
                                                                    <span
                                                                        class="text-primary">{{ $news->author->name }}</span>
                                                                </li>
                                                                <li class="list-inline-item">
                                                                    <span
                                                                        class="text-dark text-capitalize">{{ date('M d, Y', strtotime($news->created_at)) }}</span>
                        ...
                        <aside class="wrapper__list__article" style="margin-bottom: 12px">
                        ...
                        <aside class="wrapper__list__article" style="margin-bottom:24px">
                            <h4 class="border_section mt-5">{{ __('Đăng ký nhận tin') }}</h4>
                            <!-- Form Subscribe -->
                            <form class="widget__form-subscribe bg__card-shadow" id="form-newsletter">
                                @csrf
                                <h6>{{ _('Nhận bản tin hàng ngày') }}</h6>
                                <p><small>{{ _('Vui lòng nhập email của bạn') }}</small></p>
                                <div class="input-group">
                                    <input type="email" class="form-control" placeholder="{{ _('Địa chỉ email') }}"
                                        name="email" id="newsletter-email">
