        ...
        <tr>
            ...
            <td class="container">
                <div class="content">
                    ...
                    <span class="preheader">Quên Mật Khẩu</span>
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main">
                        ...
                        <tr>
                            <td class="wrapper">
                                <p>Xin chào</p>
                                <p>
                                    Bạn nhận được email này vì chúng tôi nhận được yêu cầu đặt lại mật khẩu cho tài
                                    khoản
                                    của bạn.
                                </p>
                                        ...
                                        <tr>
                                            <td align="left">
                                                <table role="presentation" border="0" cellpadding="0"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td> <a href="{{ route('admin.password.reset', $token) }}"
                                                                    target="_blank">
                                                                    Đặt Lại Mật Khẩu
                                                                </a> </td>
                                                        </tr>
